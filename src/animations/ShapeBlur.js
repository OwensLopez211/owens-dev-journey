...
`;
const ShapeBlur = ({ className = '', variation = 0, pixelRatioProp = 2, shapeSize = 1.2, roundness = 0.4, borderSize = 0.05, circleSize = 0.3, circleEdge = 0.5, }) => {
    ...
    return _jsx("div", { ref: mountRef, className: `w-full h-full ${className}` });
};
